                     ...
                     <div class="rounded-md bg-white shadow-xs">
                       <div class="mt-6">
                         <nav class="grid gap-y-8">
                           ...
                           <a href="/SGResources" class="text-base font-medium text-gray-500 hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-teal-600 p-3">
                             Resources
                           </a>
