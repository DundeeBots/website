<template>
  <div class="font-sans">
      ...
      -->
          ...
          >
            <div class="sm:text-center lg:text-left">
              ...
              >
                DundeeBots is a project that will explore, design and
    ...
    <div
      class="relative pt-16 pb-20 px-4 sm:px-6 lg:pt-24 lg:pb-28 lg:px-8 bg-gray-50"
    >
      <div class="absolute inset-0">
        <div class="bg-gray-50 h-1/3 sm:h-2/3"></div>
      </div>
      <div class="relative max-w-7xl mx-auto bg-gray-50">
          ...
          <div class="mt-8 sm:w-full sm:max-w-md xl:mt-0 xl:ml-8">
            <form class="sm:flex">
              ...
              <input
                ...
                autocomplete="email"
                required
                class="w-full border-white px-5 py-3 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-teal-700 focus:ring-white rounded-md"
                placeholder="Enter your email"
              />
              <button
                type="submit"
                class="mt-3 w-full flex items-center justify-center px-5 py-3 border border-transparent shadow text-base font-medium rounded-md text-white bg-teal-500 hover:bg-teal-400 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-teal-700 focus:ring-white sm:mt-0 sm:ml-3 sm:w-auto sm:flex-shrink-0"
              >
                Notify me
              </button>
            </form>
    ...
    <footer class="bg-white">
      <div class="max-w-7xl mx-auto py-12 px-4 overflow-hidden sm:px-6 lg:px-8">
        <h1 class="text-center text-base text-gray-400">
          Funded by the <span class="text-teal-500">IET</span>
        </h1>
        <h1 class="mt-4 text-center text-base text-gray-400">
