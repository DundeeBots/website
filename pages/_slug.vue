    ...
    <footer class="bg-white">
      <div class="max-w-7xl mx-auto py-12 px-4 overflow-hidden sm:px-6 lg:px-8">
        ...
        <div class="mt-8 flex justify-center space-x-6">
          ...
          <a href="https://twitter.com/search?q=%23DundeeBots&src=typed_query" class="text-gray-400 hover:text-gray-500">
          ...
          <a href="mailto:info@dundeebots.uk" class="text-gray-400 hover:text-gray-500">
